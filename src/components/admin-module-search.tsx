...
const ADMIN_MODULE_SEARCH_ITEMS: AdminModuleSearchItem[] = [
  ...
  { href: "/admin?tab=settings&section=profile&subTab=branding", label: "品牌基础", category: "站点设置子页", description: "配置站点名称、Logo 文案、Slogan 和编辑时效。", keywords: ["品牌基础", "站点名称", "logo文案", "slogan", "帖子可编辑分钟数", "评论可编辑分钟数", "编辑时效"] },
  { href: "/admin?tab=settings&section=profile&subTab=homepage", label: "首页展示", category: "站点设置子页", description: "配置帖子链接模式、首页 feed、侧栏卡片和搜索开关。", keywords: ["首页展示", "帖子链接显示模式", "slug模式", "id模式", "首页帖子列表形式", "画廊模式", "右侧统计卡片", "站点公告", "站内搜索"] },
  { href: "/admin?tab=settings&section=profile&subTab=seo", label: "SEO 与统计", category: "站点设置子页", description: "配置站点描述、SEO 关键字和页脚统计代码。", keywords: ["seo", "统计代码", "页脚统计代码", "站点seo关键字", "metadata keywords", "站点描述"] },
  ...
  { href: "/admin?tab=settings&section=registration&subTab=invite", label: "注册与邀请码", category: "站点设置子页", description: "控制注册开关、邀请码策略和邀请奖励。", keywords: ["注册与邀请码", "允许新用户注册", "显示邀请码输入框", "注册必须邀请码", "积分购买邀请码", "初始注册赠送积分", "邀请人奖励", "被邀请人奖励"] },
  { href: "/admin?tab=settings&section=registration&subTab=captcha", label: "注册验证码", category: "站点设置子页", description: "配置注册和登录验证码模式，以及 Turnstile 密钥。", keywords: ["注册验证码", "登录验证码", "turnstile", "turnstile site key", "turnstile secret key", "图形验证码", "pow验证码", "工作量证明"] },
  { href: "/admin?tab=settings&section=registration&subTab=fields", label: "注册表单字段", category: "站点设置子页", description: "配置邮箱、手机、昵称、性别和邀请人字段。", keywords: ["注册表单字段", "邮箱必填", "邮箱验证", "手机必填", "手机验证", "昵称必填", "性别必填", "邀请人输入框"] },
  { href: "/admin?tab=settings&section=registration&subTab=auth", label: "第三方登录", category: "站点设置子页", description: "配置 GitHub、Google 和 Passkey 登录参数。", keywords: ["第三方登录", "github登录", "google登录", "passkey", "github client id", "github client secret", "google client id", "passkey rp id", "passkey origin"] },
  { href: "/admin?tab=settings&section=registration&subTab=smtp", label: "SMTP 邮件", category: "站点设置子页", description: "配置 SMTP 主机、端口、账号和发件人信息。", keywords: ["smtp", "邮件发送", "smtp主机", "smtp端口", "smtp账号", "smtp密码", "授权码", "发件人地址", "ssl", "tls"] },
  { href: "/admin?tab=settings&section=board-applications", label: "节点申请设置", category: "站点设置", description: "单独控制前台节点申请入口和申请开关。", keywords: ["节点申请", "开启节点申请", "关闭节点申请", "板块申请", "节点申请开关", "前台节点申请入口"] },
  ...
  { href: "/admin?tab=settings&section=interaction&subTab=comments", label: "评论展示", category: "站点设置子页", description: "配置游客评论可见性、楼中楼默认展开数量和评论分页。", keywords: ["评论展示", "游客可查看评论", "评论区一页显示数", "楼中楼默认展开条数", "评论分页", "回复显示"] },
  { href: "/admin?tab=settings&section=interaction&subTab=content-limits", label: "内容限制", category: "站点设置子页", description: "配置发帖标题、正文和回复的最小字数与最大字数。", keywords: ["内容限制", "标题最小字数", "标题最大字数", "正文最小字数", "正文最大字数", "回复最小字数", "回复最大字数", "字数限制"] },
  { href: "/admin?tab=settings&section=interaction&subTab=anonymous-post", label: "匿名发帖", category: "站点设置子页", description: "配置匿名发帖开关、价格、次数和匿名回复身份规则。", keywords: ["匿名发帖", "匿名回复", "匿名马甲", "匿名发帖价格", "每日匿名发帖次数", "匿名帖默认匿名回复"] },
  { href: "/admin?tab=settings&section=interaction&subTab=tipping", label: "打赏送礼", category: "站点设置子页", description: "配置帖子打赏开关、次数限制、礼物列表和打赏送礼税。", keywords: ["打赏送礼", "帖子打赏", "每日可打赏次数", "单帖可打赏次数", "裸积分打赏档位", "礼物打赏", "打赏税", "送礼税", "税率BPS"] },
  { href: "/admin?tab=settings&section=interaction&subTab=reward-pool", label: "红包与聚宝盆", category: "站点设置子页", description: "配置帖子红包、随机命中概率、聚宝盆积分池和中奖概率。", keywords: ["红包与聚宝盆", "帖子红包", "红包最大积分", "每日发红包积分上限", "红包随机命中概率", "聚宝盆", "初始积分", "回复递增积分", "聚宝盆回复中奖概率"] },
  { href: "/admin?tab=settings&section=interaction&subTab=heat", label: "热度算法", category: "站点设置子页", description: "配置帖子热度权重、阈值和颜色色板。", keywords: ["热度算法", "浏览权重", "回复权重", "点赞权重", "打赏次数权重", "打赏积分权重", "热度阈值", "热度颜色", "颜色色板"] },
  { href: "/admin?tab=settings&section=interaction&subTab=preview", label: "热度预览", category: "站点设置子页", description: "实时预览热度分数和颜色阶段表现。", keywords: ["热度预览", "热度分数", "颜色预览", "浏览数", "回复数", "点赞数", "打赏次数", "打赏积分"] },
  ...
  { href: "/admin?tab=settings&section=registration&subTab=invite-codes", label: "邀请码管理", category: "站点设置子页", description: "在注册与邀请设置里管理邀请码列表、购买和使用。", keywords: ["邀请码", "邀请", "注册码", "invite code", "购买邀请码", "邀请码列表", "邀请码管理"] },
  { href: "/admin?tab=settings&section=vip&subTab=redeem-codes", label: "兑换码管理", category: "站点设置子页", description: "在积分与VIP设置里管理兑换码生成和兑换。", keywords: ["兑换码", "兑换", "redeem", "礼品码", "卡密"] },
