...
export function BackToTopButton() {
  ...
  return (
    <Button
      ...
      title="回到顶部"
    >
      <span className="pointer-events-none absolute inset-0 rounded-full bg-linear-to-b from-white/40 via-white/5 to-transparent opacity-80 dark:from-white/10 dark:via-white/5 dark:to-transparent" />
